...
<style>
	...
	*/
	header {
		...
		padding-bottom: 2rem;
		border-bottom: 1px solid #ddd; /* 底部边框，分隔线效果 */
	}
	...
	*/
	.chapter-link:hover {
		background: #e8e8e8; /* 悬停时背景加深 */
		
		/*
		【知识点】transform 变换
		- translateX(5px) 向右移动 5 像素
		- 不影响其他元素的位置
		- 性能优于改变 margin/left
		*/
